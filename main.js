...
/* harmony import */ var _newspaper_newspaper_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./newspaper/newspaper.component */ "./src/app/newspaper/newspaper.component.ts");
...
var routes = [
    ...
    { path: 'newspaper', component: _newspaper_newspaper_component__WEBPACK_IMPORTED_MODULE_5__["NewspaperComponent"] }
];
...
/* harmony import */ var _newspaper_newspaper_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./newspaper/newspaper.component */ "./src/app/newspaper/newspaper.component.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! .//app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _reverse_str_pipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./reverse-str.pipe */ "./src/app/reverse-str.pipe.ts");
/* harmony import */ var _highlight_directive__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./highlight.directive */ "./src/app/highlight.directive.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _newspaper_newspaper_component__WEBPACK_IMPORTED_MODULE_8__["NewspaperComponent"],
                _reverse_str_pipe__WEBPACK_IMPORTED_MODULE_10__["ReverseStrPipe"],
                _highlight_directive__WEBPACK_IMPORTED_MODULE_11__["HighlightDirective"]
            ],
            imports: [
...
module.exports = "<div class=\"table-responsive\">\t\t\n\t<table class=\"table table-striped\" [ngStyle]=\"{color: 'black', 'list-style': 'none', 'text-align': 'left'}\">\n\t\t<thead>\n\t\t\t<tr>\n\t\t\t\t<th>Name</th>\n\t\t\t\t<th>Price</th>\n\t\t\t</tr>\n\t\t\t<tr *ngFor=\"let book of books\" appHighlight>\n\t\t\t\t<td>{{book.name | uppercase}}</td>\n\t\t\t\t<td>{{book.price | currency}}</td>\n\t\t\t</tr>\n\t\t</thead>\n\t</table>\n</div>\n"
...
var BooksComponent = /** @class */ (function () {
    function BooksComponent() {
        this.books = [
            { name: 'Two States', price: 250 },
            { name: 'Calling Sehmat', price: 350 },
            { name: 'Half Girlfriend', price: 200 }
        ];
    }
...
var HighlightDirective = /** @class */ (function () {
    function HighlightDirective(el) {
        el.nativeElement.style.backgroundColor = '#b3b3a1';
    }
...
module.exports = "<div class=\"table-responsive\">\t\t\n\t<table class=\"table table-striped\" [ngStyle]=\"{color: 'black', 'list-style': 'none', 'text-align': 'left'}\">\n\t\t<thead>\n\t\t\t<tr>\n\t\t\t\t<th>Name</th>\n\t\t\t\t<th>Price</th>\n\t\t\t</tr>\n\t\t\t<tr *ngFor=\"let newspaper of newspapers\">\n\t\t\t\t<td>{{newspaper.name | uppercase | reverseStr}}</td>\n\t\t\t\t<td>{{newspaper.price | currency}}</td>\n\t\t\t</tr>\n\t\t</thead>\n\t</table>\n</div>\n"
...
var NewspaperComponent = /** @class */ (function () {
    function NewspaperComponent() {
        this.newspapers = [
            { name: 'The Hindu', price: 5 },
            { name: 'Hindustan Times', price: 4 },
            { name: 'Tribune', price: 6 }
        ];
    }
    ...
    NewspaperComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./newspaper.component.html */ "./src/app/newspaper/newspaper.component.html"),
            styles: [__webpack_require__(/*! ./newspaper.component.css */ "./src/app/newspaper/newspaper.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], NewspaperComponent);
...
module.exports = "<ul [ngStyle]=\"{float: 'left', 'list-style': 'none', 'text-align': 'left'}\">\n  <li>\n    <h5><a rel=\"noopener\" routerLink=\"/home\">Home</a></h5>\n  </li>\n  <li>\n    <h5><a rel=\"noopener\" routerLink=\"/books\">Books</a></h5>\n  </li>\n  <li>\n    <h5><a rel=\"noopener\" routerLink=\"/newspaper\">Newspaper</a></h5>\n  </li>\n</ul>\n"
...
module.exports = __webpack_require__(/*! /var/www/html/angular-git/angular/library/src/main.ts */"./src/main.ts");
